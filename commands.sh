...
ffmpeg -i plated.mp4 -vf drawtext="fontfile=arial.ttf: text='I am learning computer graphics!': fontcolor=black: fontsize=28: x=20: y=476 enable=between(t\,2\,9)" -c:a copy result.mp4
